...
@WebServlet("/Revendre")
public class Revendre extends HttpServlet
{
	...
	try
	{
		...
		if (quantite > 0)
		{
		    String query = "insert into titre values (default, ?, 'vente', default);";
	    ...
	    res.sendRedirect(req.getContextPath()+"/users/etatTitres.jsp?user="+iduser);
	}
	catch (Exception e)
	{
